...
--This skin was maded incredibly fast
--That's why for now it looks messy
--Will fix it later

--Some of things is untouched because i don't know what panels uses it

DFlatBlack = DFlatBlack or {}

DFlatBlack.DLib = {}
local DLib = DFlatBlack.DLib

local nomat = surface.GetTextureID('gui/corner8')

function DLib.DrawBox(x, y, w, h, color)
	if color then
...
function DLib.DrawText(text, font, x, y, col, center)
	if font then
...
function SKIN.tex.Selection		 (x, y, w, h) DLib.DrawBox(x, y, w, h, Skin.tex.SelectColor) end

SKIN.tex.Panels = {}
function SKIN.tex.Panels.Normal(x, y, w, h) DLib.DrawBox(x, y, w, h, colors.bg_bright) end
function SKIN.tex.Panels.Bright(x, y, w, h) DLib.DrawBox(x, y, w, h, Skin.bg_verybright) end
function SKIN.tex.Panels.Dark(x, y, w, h) DLib.DrawBox(x, y, w, h, Skin.background) end
function SKIN.tex.Panels.Highlight(x, y, w, h) DLib.DrawBox(x, y, w, h, Skin.bg_hightlight) end
...
function SKIN.tex.Tree(x, y, w, h, self)
	DLib.DrawBox(x, y, w, h, skin.bg_color)
end
...
function SKIN.tex.Checkbox_Checked(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.CheckBoxBG)
	DLib.DrawBox(x + 2, y + 2, w - 4, h - 4, skin.CheckBoxC)
end

function SKIN.tex.Checkbox(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.CheckBoxBG)
	DLib.DrawBox(x + 2, y + 2, w - 4, h - 4, skin.CheckBoxU)
end

function SKIN.tex.CheckboxD_Checked(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.CheckBoxBGD)
	DLib.DrawBox(x + 2, y + 2, w - 4, h - 4, skin.CheckBoxC)
end
...
function SKIN.tex.MenuBG_Column(x, y, w, h, self)
	DLib.DrawBox(x, y, w, h, skin.MenuHoverColor)
end
...
function SKIN.tex.MenuBG_Spacer(x, y, w, h, self)
	DLib.DrawBox(x, y, w, h, skin.MenuSpacer)
end

function SKIN.tex.Menu_Strip(x, y, w, h, self)
	DLib.DrawBox(x, y, w, h, skin.MenuSpacerStrip)
end

SKIN.tex.Menu_Check = GWEN.CreateTextureNormal(448, 112, 15, 15)

function SKIN.tex.Tab_Control(x, y, w, h)
	DLib.DrawBox(x, y, w, h, GetColor('TabControl', 0, 0, 0, 200))
end

function SKIN.tex.TabB_Active(x, y, w, h, self)
	DLib.DrawBox(x + 4, y, w - 8, h - 8, Selected)
end

function SKIN.tex.TabB_Inactive(x, y, w, h, self)
	DLib.DrawBox(x + 4, y + 2, w - 8, h - 2, UnSelected)
	DLib.DrawBox(x + 4, y + 12, w - 8, h - 2, UnSelected2)
end
...
function SKIN.tex.Window.Normal(x, y, w, h)
	DLib.DrawBox(x, y, w, 25, skin.background) -- top
	DLib.DrawBox(x, y, w, h, skin.background)
end

function SKIN.tex.Window.Inactive(x, y, w, h)
	DLib.DrawBox(x, y, w, 25, skin.background) -- top
	DLib.DrawBox(x, y, w, h, skin.background_inactive)
end
...
function SKIN.tex.Scroller.TrackV(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.BackColor)
end

function SKIN.tex.Scroller.ButtonV_Normal(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.ScrollerColI)
end

function SKIN.tex.Scroller.ButtonV_Hover(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.ScrollerColH)
end

function SKIN.tex.Scroller.ButtonV_Down(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.ScrollerColP)
end

function SKIN.tex.Scroller.ButtonV_Disabled(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.ScrollerColD)
end
...
function SKIN.tex.Scroller.LeftButton_Normal(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.BColor)
	DLib.DrawText('◀', 'Default', x + 2, y + 1, skin.tex.Scroller.TextColr)
end

function SKIN.tex.Scroller.LeftButton_Hover(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.BColorH)
	DLib.DrawText('◀', 'Default', x + 2, y + 1, skin.tex.Scroller.TextColr)
end

function SKIN.tex.Scroller.LeftButton_Down(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.BColorP)
	DLib.DrawText('◀', 'Default', x + 2, y + 1, skin.tex.Scroller.TextColr)
end

function SKIN.tex.Scroller.LeftButton_Disabled(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Scroller.BColorD)
	DLib.DrawText('◀', 'Default', x + 2, y + 1, skin.tex.Scroller.TextColr)
end
...
function SKIN.tex.Input.ComboBox.Normal(x, y, w, h)
	DLib.DrawBox(x, y, w, h, GetColor('ComboBoxNormal', 30, 30, 30, 150))
end

function SKIN.tex.Input.ComboBox.Hover(x, y, w, h)
	DLib.DrawBox(x, y, w, h, GetColor('ComboBoxHover', 60, 80, 60, 150))
end

function SKIN.tex.Input.ComboBox.Down(x, y, w, h)
	DLib.DrawBox(x, y, w, h, GetColor('ComboBoxDown', 80, 120, 80, 150))
end

function SKIN.tex.Input.ComboBox.Disabled(x, y, w, h)
	DLib.DrawBox(x, y, w, h, GetColor('ComboBoxDisabled', 0, 0, 0, 130))
end
...
function SKIN.tex.Input.ListBox.Background(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Input.ListBox.BG)
end
...
function SKIN.tex.Input.ListBox.EvenLine(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Input.ListBox.First)
end

function SKIN.tex.Input.ListBox.OddLine(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Input.ListBox.Second)
end

function SKIN.tex.Input.ListBox.EvenLineSelected(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.Input.ListBox.Select)
end
...
function SKIN.tex.ProgressBar.Back(x, y, w, h) 
	DLib.DrawBox(x, y, w, h, Color(90, 90, 90))
end

function SKIN.tex.ProgressBar.Front(x, y, w, h) 
	DLib.DrawBox(x + 2, y + 2, w - 4, h - 4, Color(160, 200, 130))
end
...
function SKIN.tex.CategoryList.Outer(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.CategoryList.BG)
end
...
function SKIN.tex.CategoryList.Header(x, y, w, h)
	DLib.DrawBox(x, y, w, h, skin.tex.CategoryList.Headerr)
end
