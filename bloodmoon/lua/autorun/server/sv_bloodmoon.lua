...
util.AddNetworkString("BloodMoon")
util.AddNetworkString("Eclipse")
...
concommand.Add("bloodmoon", function(ply) 
	...
	if !GetGlobalBool("BloodMoon") then BloodMoon.Start() else BloodMoon.End() end
end,nil,"Starts/Ends bloodmoon")

concommand.Add("eclipse", function(ply) 
	if IsValid(ply) and !ply:IsAdmin() then return end
	if !GetGlobalBool("Eclipse") then BloodMoon.StartEclipse() else BloodMoon.EndEclipse() end
end,nil,"Starts/Ends Eclipse")

function BloodMoon.End()
	if !GetGlobalBool("BloodMoon") then return end
	SetGlobalBool("BloodMoon",false)
	net.Start("BloodMoon")
	net.WriteBool(false)
	net.Broadcast()
