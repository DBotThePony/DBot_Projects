...
AddCSLuaFile('autorun/client/dscoreboard2/fonts.lua')
AddCSLuaFile('autorun/client/dscoreboard2/avatar.lua')
AddCSLuaFile('autorun/client/dscoreboard2/flag.lua')
AddCSLuaFile('autorun/client/dscoreboard2/panels.lua')
AddCSLuaFile('autorun/client/dscoreboard2/player_info.lua')
AddCSLuaFile('autorun/client/dscoreboard2/player_row.lua')
AddCSLuaFile('autorun/client/dscoreboard2/dplayer_row.lua')
AddCSLuaFile('autorun/client/dscoreboard2/cplayer_row.lua')
AddCSLuaFile('autorun/client/dscoreboard2/player_hover.lua')
AddCSLuaFile('autorun/client/dscoreboard2/player_list.lua')
AddCSLuaFile('autorun/client/dscoreboard2/rating.lua')
AddCSLuaFile('autorun/client/dscoreboard2/mainframe.lua')
AddCSLuaFile('autorun/client/dscoreboard2/network.lua')
AddCSLuaFile('autorun/client/dscoreboard2/hooks.lua')
