...
DBUTTON_DO_CLICK = =>
	...
	with menu
		...
		\AddSpacer()
		\AddOption('GitLab (sources)', -> gui.OpenURL('https://gitlab.com/DBotThePony/DBotProjects/tree/master/dmaps'))\SetIcon('icon16/script_code.png')
		\AddOption('Changelog (commits)', -> gui.OpenURL('https://gitlab.com/DBotThePony/DBotProjects/commits/master/dmaps'))\SetIcon('icon16/page_white_stack.png')
		\AddOption('Issues/suggestions', -> gui.OpenURL('https://gitlab.com/DBotThePony/DBotProjects/issues'))\SetIcon(table.Random(DMaps.BUGS_ICONS))
		...
		\AddOption('Creator of DMaps', -> gui.OpenURL('https://steamcommunity.com/profiles/76561198077439269'))\SetIcon('icon16/page_code.png')
		\Open()
		\SetPos(x, y)
