...
function networkWeapon(self)
	...
	if self.weaponrystats.modification then self:SetNWString('WPS.M', self.weaponrystats.modification.crc) end
	if self.weaponrystats.type then self:SetNWString('WPS.T', self.weaponrystats.type.crc) end
end
